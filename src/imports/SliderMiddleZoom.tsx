import svgPaths from "./svg-yzlwh602rl";
...
export default function SliderMiddleZoom() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Slider - Middle zoom">
      <StatusBar />
      <Status />
      <ThrustSection />
      <PressureSection />
