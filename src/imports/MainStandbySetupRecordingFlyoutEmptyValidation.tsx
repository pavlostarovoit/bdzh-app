import svgPaths from "./svg-yh3ayb9h11";
...
function Text() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-[1_0_0] flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#e32b00] text-[15px]">
        <p className="leading-[20px] whitespace-pre-wrap">Field is required.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#efefef] relative rounded-[4px] shrink-0 w-full" data-name="Text input">
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex gap-[8px] items-center justify-end px-[16px] py-[12px] relative w-full">
...
export default function MainStandbySetupRecordingFlyoutEmptyValidation() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Main - Standby - Setup recording Flyout - Empty validation">
