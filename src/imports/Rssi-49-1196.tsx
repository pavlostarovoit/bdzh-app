import svgPaths from "./svg-4cxz24skwr";
    ...
    <div className="relative shrink-0 size-[20px]" data-name="wifi-strength-1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_49_1072)" id="wifi-strength-1">
          <path d={svgPaths.p2ef2b100} fill="var(--fill-0, #D58000)" id="Vector" />
        </g>
        <defs>
...
function Rssi() {
  return (
    <div className="content-stretch flex font-['_IBM_Plex_Sans_:Medium',_sans-serif] items-center leading-[20px] not-italic relative shrink-0 text-[#d58000] text-[15px] text-nowrap whitespace-pre" data-name="RSSI">
