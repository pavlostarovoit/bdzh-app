import svgPaths from "./svg-o04zlmv3p5";
...
function Fire() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="fire">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="fire">
          <path d={svgPaths.pcd00a00} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Button1() {
  return (
    <div className="bg-[#c13211] relative rounded-[4px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[12px] relative w-full">
          <Fire />
          <div className="flex flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[15px] text-center text-white whitespace-nowrap">
            <p className="leading-[20px]">Ignite engine</p>
          </div>
        </div>
      </div>
    </div>
...
function Button() {
  return (
    <div className="bg-[#efefef] relative rounded-[8px] shadow-[0px_-1px_8px_0px_rgba(42,42,42,0.08)] shrink-0 w-full" data-name="Button">
...
export default function MainStandbyDefaultRecordingDefault() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultRecording - Default">
      <StatusBar />
      <DataSection />
      <CameraViewport />
      <Button />
