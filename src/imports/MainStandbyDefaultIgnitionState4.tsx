import svgPaths from "./svg-uexya97sd2";
...
function Numeric4Circle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="numeric-4-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="numeric-4-circle">
          <path d={svgPaths.pb078240} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function MainStandbyDefaultIgnitionState() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultIgnition - State 4">
      <StatusBar />
      <DataSection />
      <CameraViewport />
      <Button />
