import svgPaths from "./svg-km21o2v9rz";
...
export default function MainStandbyDefaultIgnitionState() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultIgnition - State 9">
      <StatusBar />
      <DataSection />
      <CameraViewport />
      <Button />
