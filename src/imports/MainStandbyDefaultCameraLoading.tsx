import svgPaths from "./svg-mjjuvc3kaw";
...
function Loader() {
  return (
    <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Loader">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="loading">
          <path d={svgPaths.p204a7710} fill="var(--fill-0, #666666)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ProgressIndicator() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Progress indicator">
      <p className="font-['_IBM_Plex_Sans_:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#666] text-[16px]">Camera loading</p>
      <Loader />
    </div>
  );
}
...
export default function MainStandbyDefaultCameraLoading() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - Default - Camera loading">
      <StatusBar />
      <DataSection />
      <CameraViewport />
    </div>
