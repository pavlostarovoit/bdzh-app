import svgPaths from "./svg-kt096b7fr5";
...
export default function StatusBar() {
  return (
    <div className="bg-[#d58000] content-stretch flex items-center justify-between p-[8px] relative size-full" data-name="Status bar">
