import svgPaths from "./svg-7ougux9mue";
...
function Data() {
  return (
    <div className="absolute bottom-[16px] left-[16px] right-0 top-0" data-name="Data">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 312 100">
        <g clipPath="url(#clip0_31_339)" id="Data">
          <path d={svgPaths.p2d916380} id="Data line" stroke="var(--stroke-0, #545454)" strokeDasharray="8 4" strokeWidth="2" />
        </g>
        <defs>
          <clipPath id="clip0_31_339">
            <rect fill="white" height="100" width="312" />
          </clipPath>
        </defs>
      </svg>
    </div>
