import svgPaths from "./svg-cwwhd40tfe";
...
function Numeric5Circle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="numeric-5-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="numeric-5-circle">
          <path d={svgPaths.p2483fb80} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function MainStandbyDefaultIgnitionState() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultIgnition - State 5">
      <StatusBar />
      <DataSection />
      <CameraViewport />
      <Button />
