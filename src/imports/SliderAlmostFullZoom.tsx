import svgPaths from "./svg-x7go72xnsk";
...
function TopSection() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Top section">
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="Bottom section">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[8px] items-center justify-center px-[4px] relative size-full">
          ...
          <div className="-translate-x-1/2 absolute left-1/2 overflow-clip size-[20px] top-[8px]" data-name="magnify-plus-outline">
            <div className="absolute inset-[12.5%_14.58%_14.58%_12.5%]" data-name="Vector">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.5833 14.5833">
                <path d={svgPaths.p25058200} fill="var(--fill-0, black)" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
...
export default function SliderAlmostFullZoom() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Slider - Almost full zoom">
      <StatusBar />
      <Status />
      <ThrustSection />
      <PressureSection />
