import svgPaths from "./svg-z1p796ypot";
...
function Title() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px py-[12px] relative" data-name="Title">
      <div className="flex flex-[1_0_0] flex-col font-['_IBM_Plex_Sans_:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[15px] text-white">
        <p className="leading-[20px]">Cannot reach server. Check connection and try again.</p>
      </div>
    </div>
  );
}
...
function Button() {
  return (
    <div className="content-stretch cursor-pointer flex h-full items-center px-[16px] relative shrink-0" data-name="Button">
      ...
      <div className="overflow-clip relative rounded-[3px] shrink-0 size-[20px]" data-name="close">
        <div className="absolute inset-[20.83%]" data-name="close-24">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.6667 11.6667">
            <path d={svgPaths.p2a4bf680} fill="var(--fill-0, white)" id="close-24" />
          </svg>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Title">
      ...
      <div className="content-stretch flex gap-[24px] items-start p-[16px] relative w-full">
        <div className="flex flex-[1_0_0] flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative self-stretch text-[16px] text-black">
          <p className="leading-[24px]">Setup new recording</p>
        </div>
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[12px] relative w-full">
          ...
          <div className="flex flex-[1_0_0] flex-col font-['_IBM_Plex_Sans_:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[15px] text-black">
            <p className="leading-[20px]">5333.1</p>
          </div>
          <div className="content-stretch cursor-pointer flex items-center relative rounded-[4px] shrink-0" data-name="Button">
            <div className="overflow-clip relative rounded-[3px] shrink-0 size-[20px]" data-name="close">
              <div className="absolute inset-[20.83%]" data-name="close-24">
  ...
  return (
    <div className="bg-[#efefef] relative rounded-[4px] shrink-0 w-full" data-name="Text input">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[12px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['_IBM_Plex_Sans_:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[15px] text-black">
            <p className="leading-[20px]">5333.22</p>
          </div>
          <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Link">
            <div className="flex flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0a64eb] text-[15px] text-center whitespace-nowrap">
              <p className="[text-decoration-skip-ink:none] decoration-solid leading-[20px] underline">Use load cell</p>
            </div>
          </div>
          <div className="flex flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#777] text-[15px] whitespace-nowrap">
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 whitespace-nowrap">
      <div className="flex flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] relative shrink-0 text-black">
  ...
  return (
    <div className="bg-[#efefef] relative rounded-[4px] shrink-0 w-full" data-name="Text input">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[12px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['_IBM_Plex_Sans_:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[15px] text-black">
            <p className="leading-[20px]">5210</p>
          </div>
          <div className="flex flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#777] text-[15px] whitespace-nowrap">
            <p className="leading-[20px]">g</p>
          </div>
  ...
  return (
    <div className="bg-[#efefef] relative rounded-[4px] shrink-0 w-full" data-name="Text input">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[12px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['_IBM_Plex_Sans_:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[15px] text-black">
            <p className="leading-[20px]">Some notes here</p>
          </div>
          <div className="content-stretch cursor-pointer flex items-center relative rounded-[4px] shrink-0" data-name="Button">
            <div className="overflow-clip relative rounded-[3px] shrink-0 size-[20px]" data-name="close">
              <div className="absolute inset-[20.83%]" data-name="close-24">
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-start px-[16px] relative w-full">
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Text field">
          <div className="content-stretch flex gap-[12px] items-start not-italic relative shrink-0 text-[15px] w-full" data-name="Label">
            ...
            <p className="flex-[1_0_0] font-['_IBM_Plex_Sans_:Regular',sans-serif] leading-[20px] min-h-px min-w-px relative text-[#666] text-right">0/6 latin characters, ASCII symbols</p>
          </div>
          <TextInput />
        </div>
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[328px]" data-name="Text field">
          <div className="content-stretch flex gap-[12px] items-start not-italic relative shrink-0 text-[15px] w-full" data-name="Label">
            <div className="flex flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] relative shrink-0 text-black whitespace-nowrap">
              <p className="leading-[20px]">Total mass</p>
            </div>
            <p className="flex-[1_0_0] font-['_IBM_Plex_Sans_:Regular',sans-serif] leading-[20px] min-h-px min-w-px relative text-[#666] text-right">TWR calculation, grams</p>
          </div>
          <TextInput1 />
        </div>
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Text field">
          <div className="content-stretch flex gap-[12px] items-start not-italic relative shrink-0 text-[15px] w-full" data-name="Label">
            <Frame />
            <p className="flex-[1_0_0] font-['_IBM_Plex_Sans_:Regular',sans-serif] leading-[20px] min-h-px min-w-px relative text-[#666] text-right">ISP calculation, grams</p>
          </div>
          <TextInput2 />
        </div>
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Text field">
          <div className="content-stretch flex gap-[12px] items-start not-italic relative shrink-0 text-[15px] w-full" data-name="Label">
            <Frame1 />
            <p className="flex-[1_0_0] font-['_IBM_Plex_Sans_:Regular',sans-serif] leading-[20px] min-h-px min-w-px relative text-[#666] text-right">ASCII symbols</p>
          </div>
          <TextInput3 />
        </div>
      </div>
...
function Buttons() {
  return (
    <div className="relative shrink-0 w-full" data-name="Buttons">
      <div className="content-stretch cursor-pointer flex gap-[12px] items-start px-[16px] relative w-full">
...
function SetupNewRecordingModal() {
  return (
    <div className="absolute bg-white bottom-0 content-stretch flex flex-col gap-[16px] items-center justify-end left-0 overflow-clip pb-[16px] right-0 rounded-tl-[4px] rounded-tr-[4px] shadow-[0px_-1px_8px_0px_rgba(42,42,42,0.08)] z-[7]" data-name="Setup new recording modal">
      <Title1 />
      <TextField />
...
function Rssi() {
  return (
    <div className="content-stretch flex font-['_IBM_Plex_Sans_:Medium',sans-serif] items-center leading-[20px] not-italic relative shrink-0 text-[#545454] text-[15px] whitespace-nowrap" data-name="RSSI">
...
function DateTime() {
  return (
    <div className="content-stretch flex font-['_IBM_Plex_Sans_:Medium',sans-serif] gap-[4px] items-center leading-[20px] not-italic px-[4px] relative rounded-[4px] shrink-0 text-[#545454] text-[15px] whitespace-nowrap" data-name="Date & Time">
        ...
        <div className="content-stretch flex items-center justify-between p-[8px] relative w-full">
          <div className="content-stretch flex gap-[4px] items-center px-[4px] relative rounded-[4px] shrink-0" data-name="RSSI">
            ...
            <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Refresh rate">
              <p className="font-['_IBM_Plex_Sans_:Medium',sans-serif] leading-[20px] not-italic opacity-50 relative shrink-0 text-[#545454] text-[15px] whitespace-nowrap">10ms</p>
...
function Title2() {
  return (
    <div className="content-stretch flex h-[24px] items-start justify-between not-italic relative shrink-0 text-right w-full whitespace-nowrap" data-name="Title">
...
function Component3() {
  return (
    <div className="content-stretch flex gap-[8px] h-[20px] items-center relative shrink-0 w-full" data-name="3">
      <p className="font-['_IBM_Plex_Sans_:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#545454] text-[13px] whitespace-nowrap">3</p>
...
function Component2() {
  return (
    <div className="content-stretch flex gap-[8px] h-[20px] items-center relative shrink-0 w-full" data-name="2">
      <p className="font-['_IBM_Plex_Sans_:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#545454] text-[13px] whitespace-nowrap">2</p>
      <div className="flex-[1_0_0] h-0 min-h-px min-w-px relative" data-name="Guide line">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 312 1">
            <line id="Guide line" stroke="var(--stroke-0, #EFEFEF)" x2="312" y1="0.5" y2="0.5" />
...
function Component1() {
  return (
    <div className="content-stretch flex gap-[8px] h-[20px] items-center relative shrink-0 w-full" data-name="1">
      <p className="font-['_IBM_Plex_Sans_:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#545454] text-[13px] whitespace-nowrap">1</p>
      <div className="flex-[1_0_0] h-0 min-h-px min-w-px relative" data-name="Guide line">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 312 1">
            <line id="Guide line" stroke="var(--stroke-0, #EFEFEF)" x2="312" y1="0.5" y2="0.5" />
...
function Component() {
  return (
    <div className="content-stretch flex gap-[8px] h-[20px] items-center relative shrink-0 w-full" data-name="0">
      <p className="font-['_IBM_Plex_Sans_:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#545454] text-[13px] whitespace-nowrap">0</p>
      <div className="flex-[1_0_0] h-0 min-h-px min-w-px relative" data-name="Guide line">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 312 1">
            <line id="Guide line" stroke="var(--stroke-0, #EFEFEF)" x2="312" y1="0.5" y2="0.5" />
...
function Seconds() {
  return (
    <div className="relative shrink-0 w-full" data-name="Seconds">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex font-['_IBM_Plex_Sans_:Regular',sans-serif] items-center justify-between leading-[16px] not-italic pl-[12px] relative text-[#545454] text-[13px] text-right w-full whitespace-nowrap">
...
export default function MainStandbySetupRecordingFlyoutNoServerResponseNoConnection() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Main - Standby - Setup recording Flyout - No server response - No connection">
      <div className="absolute bg-[#e32b00] content-stretch flex gap-[16px] items-center left-[8px] overflow-clip pl-[16px] right-[8px] rounded-[4px] top-[44px] z-[8]" data-name="Toast">
        <Title />
      ...
      <div className="absolute backdrop-blur-[8px] bg-[#f7f7f7] inset-[36px_0_-1px_0] opacity-90 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] z-[6]" data-name="BG" />
      <StatusBar />
      <Status />
      <ThrustSection />
      <PressureSection />
