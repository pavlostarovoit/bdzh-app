import svgPaths from "./svg-pf8v7cdm9a";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Title">
      ...
      <div className="content-stretch flex gap-[24px] items-start p-[16px] relative w-full">
        <div className="flex flex-[1_0_0] flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[16px] text-black">
          <p className="leading-[24px] whitespace-pre-wrap">Setup new recording</p>
        </div>
        <div className="content-stretch cursor-pointer flex items-center relative rounded-[4px] shrink-0 size-[20px]" data-name="Button">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[12px] relative w-full">
          <div className="flex flex-[1_0_0] flex-col font-['_IBM_Plex_Sans_:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[15px] text-black">
            <p className="leading-[20px] whitespace-pre-wrap">5333.22</p>
          </div>
          <div className="flex flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#777] text-[15px] whitespace-nowrap">
    ...
    <div className="relative shrink-0 w-full" data-name="Text field">
      <div className="content-stretch flex flex-col gap-[16px] items-start px-[16px] relative w-full">
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Text field">
          <div className="content-stretch flex gap-[12px] items-start leading-[0] not-italic relative shrink-0 text-[15px] w-full" data-name="Label">
            <div className="flex flex-col font-['_IBM_Plex_Sans_:Medium',sans-serif] justify-center relative shrink-0 text-black whitespace-nowrap">
              <p className="leading-[20px]">Engine ID</p>
            </div>
            <p className="flex-[1_0_0] font-['_IBM_Plex_Sans_:Regular',sans-serif] min-h-px min-w-px relative text-[#666] text-right whitespace-pre-wrap">
              <span className="leading-[20px]">{`0/6 latin characters, `}</span>
              <span className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px]">ASCII symbols</span>
            </p>
          </div>
          <TextInput />
        </div>
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[328px]" data-name="Text field">
          <div className="content-stretch flex gap-[12px] items-start not-italic relative shrink-0 text-[15px] w-full" data-name="Label">
            ...
            <p className="flex-[1_0_0] font-['_IBM_Plex_Sans_:Regular',sans-serif] leading-[20px] min-h-px min-w-px relative text-[#666] text-right whitespace-pre-wrap">TWR calculation, grams</p>
          </div>
          <TextInput1 />
        </div>
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Text field">
...
export default function MainStandbySetupRecordingFlyoutEmpty() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Main - Standby - Setup recording Flyout - Empty">
