import svgPaths from "./svg-9c81b5i1bs";
...
export default function MainStandbyDefaultRecordingIgnitedDefault() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultRecording & Ignited - Default">
      <StatusBar />
      <DataSection />
      <CameraViewport />
    </div>
