import svgPaths from "./svg-a1sx6a1pq3";
...
function Numeric8Circle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="numeric-8-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="numeric-8-circle">
          <path d={svgPaths.p3b1b080} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function MainStandbyDefaultIgnitionState() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultIgnition - State 8">
      <StatusBar />
      <DataSection />
      <CameraViewport />
      <Button />
