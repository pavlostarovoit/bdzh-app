import svgPaths from "./svg-pyzlugc8j9";
...
function Data() {
  return (
    <div className="absolute bottom-[26px] box-border content-stretch flex flex-col gap-[8px] items-start left-[16px] overflow-clip pb-[10.5px] pt-0 px-0 right-0 top-0" data-name="Data">
      <div className="h-[89px] relative shrink-0 w-full" data-name="Data line">
        <div className="absolute bottom-[-1.12%] left-0 right-[-0.22%] top-[-0.8%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 313 91">
            <path d={svgPaths.p31009348} id="Data line" stroke="var(--stroke-0, #545454)" strokeDasharray="8 4" strokeWidth="2" />
          </svg>
        </div>
      </div>
    </div>
