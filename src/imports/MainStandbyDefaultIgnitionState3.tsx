import svgPaths from "./svg-2fljy4wot8";
...
function Numeric3Circle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="numeric-3-circle">
...
export default function MainStandbyDefaultIgnitionState() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultIgnition - State 3">
      <StatusBar />
      <DataSection />
      <CameraViewport />
      <Button />
