import svgPaths from "./svg-zfvwnlcp82";
...
export default function SliderMinimumZoom() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Slider - Minimum zoom">
      <StatusBar />
      <Status />
      <ThrustSection />
      <PressureSection />
