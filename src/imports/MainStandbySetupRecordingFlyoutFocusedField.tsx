import svgPaths from "./svg-j79wc84mrr";
...
export default function MainStandbySetupRecordingFlyoutFocusedField() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Main - Standby - Setup recording Flyout - Focused field">
