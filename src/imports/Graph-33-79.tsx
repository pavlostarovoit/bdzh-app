import svgPaths from "./svg-xxzzy2ohdm";
  ...
  return (
    <div className="absolute bottom-[26px] left-[16px] right-0 top-0" data-name="Data">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 312 90">
        <g clipPath="url(#clip0_32_404)" id="Data">
          <path d={svgPaths.p1d2705c0} id="Data line" stroke="var(--stroke-0, #545454)" strokeDasharray="8 4" strokeWidth="2" />
        </g>
        <defs>
