import svgPaths from "./svg-f7ypymgiwb";
  ...
  return (
    <div className="absolute inset-[0_0_26px_16px]" data-name="Data">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 312 90">
        <g clipPath="url(#clip0_346_374)" id="Data">
...
function BottomSection() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Bottom section">
      <div className="flex flex-row items-center justify-center size-full">
...
function CameraViewport() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px pr-px relative w-full z-[1]" data-name="Camera viewport">
      ...
      <div className="absolute content-stretch flex flex-col gap-[4px] h-[218px] items-start right-[20px] rounded-[40px] top-[16px] w-[60px]" data-name="Zoom control - expanded">
        <TopSection />
        <div className="flex h-[4.092px] items-center justify-center relative shrink-0 w-full" style={{ "--transform-inner-width": "1200.0999755859375", "--transform-inner-height": "0" } as React.CSSProperties}>
...
export default function SliderAlmostMinimumZoom() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Slider - Almost minimum zoom">
      <StatusBar />
      <Status />
      <ThrustSection />
      <PressureSection />
