import svgPaths from "./svg-6f6de4nb3a";
...
function Numeric6Circle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="numeric-6-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="numeric-6-circle">
          <path d={svgPaths.p16fe3580} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function MainStandbyDefaultIgnitionState() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultIgnition - State 6">
      <StatusBar />
      <DataSection />
      <CameraViewport />
      <Button />
