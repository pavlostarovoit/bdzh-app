import svgPaths from "./svg-qmbsezqx74";
...
export default function SliderFullZoom() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Slider - Full zoom">
      <StatusBar />
      <Status />
      <ThrustSection />
      <PressureSection />
