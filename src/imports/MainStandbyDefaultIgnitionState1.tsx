import svgPaths from "./svg-2xql44j3xz";
...
function Numeric1Circle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="numeric-1-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="numeric-1-circle">
          <path d={svgPaths.p3c393a70} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function MainStandbyDefaultIgnitionState() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultIgnition - State 1">
      <StatusBar />
      <DataSection />
      <CameraViewport />
      <Button />
