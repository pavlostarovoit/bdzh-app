import svgPaths from "./svg-6ccqc0bb1r";
...
function Numeric2Circle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="numeric-2-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="numeric-2-circle">
          <path d={svgPaths.p11500a00} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function MainStandbyDefaultIgnitionState() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Main - Standby - DefaultIgnition - State 2">
      <StatusBar />
      <DataSection />
      <CameraViewport />
      <Button />
