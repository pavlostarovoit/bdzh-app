import svgPaths from "./svg-jeo729uwqm";
  ...
  return (
    <div className="absolute inset-[0_0_26px_16px]" data-name="Data">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 312 90">
        <g clipPath="url(#clip0_240_358)" id="Data">
...
function CameraViewport() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px pr-px relative w-full z-[1]" data-name="Camera viewport">
      ...
      <div className="absolute bg-black content-stretch cursor-pointer flex gap-[8px] items-center justify-center left-[235px] overflow-clip p-[16px] rounded-[4px] top-[290px]" data-name="Record button">
...
export default function MainStandbyDefault() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center relative size-full" data-name="Main - Standby - Default">
      <StatusBar />
      <Status />
      <ThrustSection />
      <PressureSection />
