 ...
 */
const CACHE_NAME = 'thrust-monitor-v2';
...
function isCacheableRequest(url) {
  // Never cache measurement API or control endpoints
...
self.addEventListener('fetch', (event) => {
  ...
  // For navigation requests (HTML pages), serve from cache first for instant load
